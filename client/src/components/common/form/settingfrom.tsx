  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col justify-center items-center ">
        <label htmlFor="email" className="text-gray-700 mb-2 text-sm font-medium relative top-[80px] right-[115px] ">
        メールアドレス
        </label>
        <input
          type="email"
        ...
        />
         <label htmlFor="userId" className="text-gray-700 mb-2 text-sm font-medium relative top-[90px] right-[115px]">
         ユーザーID
         </label>
        <input
          type="userId"
        ...
        />
        <label htmlFor="userId" className="text-gray-700 mb-2 text-sm font-medium relative top-[100px] right-[115px]">
         アカウント名
         </label>
        <input
          type="userName"
